...
**Test-only optimization:** patterns `*.test.*`, `*.spec.*`, `**/test/**`, `**/tests/**`, `**/__tests__/**`, `**/fixtures/**`, `**/test-helpers/**`, `**/test-utils/**` — reduced reviewers for step 3: edge-case-hunter, requirements-reviewer, simplification-reviewer. Mechanics: "Scoped retry convergence" in shared/convergence.md.
